        ...
        <div className="max-w-[1400px] mx-auto bg-white/70 backdrop-blur-[32px] border border-white/80 shadow-[0_30px_90px_rgba(70,90,220,0.05)] rounded-[40px] p-8 md:p-16 lg:p-24 relative overflow-hidden">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white border border-gray-200/60 mb-8 shadow-sm"
            >
              <Sparkles className="w-4 h-4 text-[#465ADC]" />
              <span className="text-sm font-semibold text-slate-800 tracking-wide uppercase">AI Business Intelligence</span>
            </motion.div>
